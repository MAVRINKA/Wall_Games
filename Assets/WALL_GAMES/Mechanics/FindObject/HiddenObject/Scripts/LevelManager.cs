...
public class LevelManager : MonoBehaviour
{
    ...
    void AssignHiddenObjects()  //Method select objects from the hiddenobjects list which should be hidden
    {
        ...
        UIManagerHidden.instance.TimerText.text = "" + timeLimit;                 //set the timer text of UIManager
        ...
        UIManagerHidden.instance.PopulateHiddenObjectIcons(activeHiddenObjectList);   //send the activeHiddenObjectList to UIManager
